...
public partial class MainPage : ContentPage, INotifyPropertyChanged
{
    ...
    public static readonly BindableProperty LastChangedProperty = BindableProperty.Create(
        nameof(LastChanged),
        typeof(string),
        typeof(MainPage)
    );
    ...
    public static readonly BindableProperty ApiKeyProperty = BindableProperty.Create(
        nameof(ApiKey),
        typeof(string),
        typeof(MainPage)
    );
